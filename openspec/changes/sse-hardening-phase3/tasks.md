...
- [ ] 2.5 Add cache metrics (Micrometer `CacheMeterBinderProvider`)
...
- [ ] 3.2 Implement naming convention configuration (singularize, prefix, case)
...
- [ ] 4.3 Add RBAC check for federated tenant access
- [ ] 4.4 Add configurable timeout and concurrency limits
...
- [ ] 7.1 Write tests for auth hardening (rate limiting, JWT blacklist, cache eviction, audit logging)
- [ ] 7.2 Write tests for query caching (hit/miss/eviction/clear)
- [ ] 7.3 Write tests for OWL generation
- [ ] 7.4 Write tests for federated query
- [ ] 7.5 Write tests for GraphQL endpoint
- [ ] 7.6 Write tests for ontology visualization
